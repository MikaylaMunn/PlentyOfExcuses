            ...
            <div className="ui middle aligned stackable grid container bg-light">
                <div className="row">
                    <div className="eight wide column text-center">
                        <h2 className="text-danger">Meet Our Trainers</h2>
                        <h2 className="text-danger">Here are some of the trainers we have. Many have been in your same boat. We hope you enjoy them too. </h2>
